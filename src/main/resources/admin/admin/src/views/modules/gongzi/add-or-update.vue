<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="工资年月" prop="gongzinianyue">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.gongzinianyue" 
                type="datetime"
                placeholder="工资年月">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gongzinianyue" label="工资年月" prop="gongzinianyue">
              <el-input v-model="ruleForm.gongzinianyue" 
                placeholder="工资年月" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="应发工资" prop="yingfagongzi">
            <el-input v-model="yingfagongzi"
                placeholder="应发工资" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yingfagongzi" label="应发工资" prop="yingfagongzi">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiesuanriqi" label="结算日期" prop="jiesuanriqi">
              <el-input v-model="ruleForm.jiesuanriqi" 
                placeholder="结算日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    yingfagongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jiangjin==""?0:this.ruleForm.jiangjin)-parseFloat(this.ruleForm.fakuan==""?0:this.ruleForm.fakuan) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='gongzinianyue'){
            this.ruleForm.gongzinianyue = obj[o];
	    this.ro.gongzinianyue = true;
            continue;
          }
          if(o=='jibengongzi'){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.yingfagongzi = this.yingfagongzi
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
